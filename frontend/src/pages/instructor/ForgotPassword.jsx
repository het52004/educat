...
function ForgotPassword() {
  ...
  const requestPasswordReset = useInstructorAuthStore((state) => state.requestPasswordReset);
  const resetPassword = useInstructorAuthStore((state) => state.resetPassword);
  const forgotPasswordError = useInstructorAuthStore((state) => state.forgotPasswordError);
  const resetPasswordError = useInstructorAuthStore((state) => state.resetPasswordError);
